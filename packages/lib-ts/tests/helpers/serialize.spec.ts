import { TriggerConfig } from '../../src/context'
...
describe('serialize', () => {
  ...
  describe('deserializeCronTriggerConfigData', () => {
    it('decodes a uint256 correctly', () => {
      ...
      const deserialized = TriggerConfig.deserializeCronTriggerConfigData(data)
      expect(deserialized.toString()).toBe('1758298140000')
    })
  })

  describe('deserializeEventTriggerConfigData', () => {
    it('decodes the event correctly', () => {
      ...
      const event = TriggerConfig.deserializeEventTriggerConfigData(data)
