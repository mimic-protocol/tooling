...
describe('serialize', () => {
  ...
  describe('deserializeCronConfigData', () => {
    it('decodes a uint256 correctly', () => {
      ...
      const deserialized = Config.deserializeCronConfigData(data)
      expect(deserialized.toString()).toBe('1758298140000')
    })
  })

  describe('deserializeEventConfigData', () => {
    it('decodes the event correctly', () => {
      ...
      const event = Config.deserializeEventConfigData(data)
