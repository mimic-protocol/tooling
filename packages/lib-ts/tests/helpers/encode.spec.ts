...
describe('evmEncode', () => {
  describe('Input Validation', () => {
    ...
    it('should throw if a static parameter exceeds 32 bytes', () => {
      expect(() => {
        const params: CallParam[] = [new CallParam('bytes33', Bytes.fromHexString(randomHex(33)))]
  ...
  describe('Encoding Logic', () => {
    ...
    it('should encode static parameters correctly', () => {
      const addr = Address.fromString(randomAddress())
      const amount = BigInt.fromU64(1000)
    ...
    it('should encode a single dynamic parameter (string) correctly', () => {
      ...
      const stringBytes = Bytes.fromUTF8(testString)
      const params: CallParam[] = [new CallParam('string', stringBytes)]

      const expectedOffset = padTo32Bytes('0x20')
      const expectedLength = padTo32Bytes(testString.length.toString(16))
      const expectedData = padTo32Bytes(stringBytes.toHexString(), true).substring(2)
    ...
    it('should encode a single dynamic parameter (bytes) correctly', () => {
      const testBytes = Bytes.fromHexString(randomHex(6))
      const params: CallParam[] = [new CallParam('bytes', testBytes)]

      const expectedOffset = padTo32Bytes('0x20')
      const expectedLength = padTo32Bytes(testBytes.length.toString(16))
      const expectedData = padTo32Bytes(testBytes.toHexString(), true).substring(2)
    ...
    it('should encode mixed static and dynamic parameters correctly', () => {
      const val1 = BigInt.fromU64(123)
      const val2 = 'dynamic data'
      const val3 = Address.fromString(randomAddress())
      const val4 = Bytes.fromHexString(randomHex(4))
      ...
      const expectedOffsetVal2 = padTo32Bytes('0x80')
      ...
      const expectedLengthVal2 = padTo32Bytes(val2.length.toString(16))
      const expectedDataVal2 = padTo32Bytes(Bytes.fromUTF8(val2).toHexString(), true).substring(2)
      const expectedLengthVal4 = padTo32Bytes(val4.length.toString(16))
      const expectedDataVal4 = padTo32Bytes(val4.toHexString(), true).substring(2)
    ...
    it('should encode multiple dynamic parameters correctly', () => {
      const length = 2
      const val1 = 'first'
      const val2 = Bytes.fromHexString(randomHex(length))
      const val3 = 'third string'
      ...
      const expectedOffsetVal2 = padTo32Bytes('0xa0')
      const expectedOffsetVal3 = padTo32Bytes('0xe0')

      const expectedLengthVal1 = padTo32Bytes(val1.length.toString(16))
      const expectedDataVal1 = padTo32Bytes(val1Bytes.toHexString(), true).substring(2)
      const expectedLengthVal2 = padTo32Bytes((length / 2).toString(16))
      const expectedDataVal2 = padTo32Bytes(val2Bytes.toHexString(), true).substring(2)
      const expectedLengthVal3 = padTo32Bytes(val3.length.toString(16))
      const expectedDataVal3 = padTo32Bytes(val3Bytes.toHexString(), true).substring(2)
...
describe('evmEncodeArray', () => {
  describe('Dynamic Arrays', () => {
    ...
    it('should encode dynamic array of BigInt values', () => {
      ...
      const expectedLength = padTo32Bytes(values.length.toString(16))
    ...
    it('should encode dynamic array of Address values', () => {
      const addr1 = Address.fromString(randomAddress())
      const addr2 = Address.fromString(randomAddress())
