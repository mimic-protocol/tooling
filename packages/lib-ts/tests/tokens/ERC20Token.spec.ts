...
describe('ERC20Token', () => {
  describe('create', () => {
    ...
    describe('when the address is not the native address', () => {
      it('looks for the symbol on chain', () => {
        const token = ERC20Token.fromAddress(randomAddress(), 1)
      ...
      it('uses the cache if it was created with a symbol', () => {
        const token = ERC20Token.fromAddress(randomAddress(), 1, ERC20Token.EMPTY_DECIMALS, 'USDC')
      ...
      it('uses the cache if it was created with decimals', () => {
        const token = ERC20Token.fromAddress(randomAddress(), 1, 6)
  ...
  describe('isUSD', () => {
    ...
    describe('when the token is not USD', () => {
      it('returns false', () => {
        const token = new DenominationToken(randomAddress(), 6, 'EUR')
  ...
  describe('equals', () => {
    describe('when comparing two ERC20 tokens', () => {
      describe('when using the same chain', () => {
        ...
        it('returns false for tokens with different addresses', () => {
          const token1 = ERC20Token.fromAddress(randomAddress(), chainId, 18, 'TOKEN')
          const token2 = ERC20Token.fromAddress(randomAddress(), chainId, 18, 'TOKEN')
    ...
    describe('when comparing two different tokens', () => {
      ...
      it('returns false for tokens with different addresses', () => {
        const token1 = new DenominationToken(randomAddress(), 18, 'TOKEN')
