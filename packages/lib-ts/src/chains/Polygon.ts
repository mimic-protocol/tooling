...
export namespace Polygon {
  ...
  export const WBTC = new Token('0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6', ChainId.POLYGON, 8, 'WBTC')
  export const WETH = new Token('0x7ceb23fd6bc0add59e62ac25578270cff1b9f619', ChainId.POLYGON, 18, 'WETH')
}
