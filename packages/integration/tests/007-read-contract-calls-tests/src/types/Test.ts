...
export class Test {
  ...
  getBool(): bool {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x12a7b914')
    const decodedResponse = evm.decode(new EvmDecodeParam('bool', response))
    return u8.parse(decodedResponse) as bool
  }

  getBytes(): Bytes {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x0bcd3b33')
    const decodedResponse = evm.decode(new EvmDecodeParam('bytes', response))
    return Bytes.fromHexString(decodedResponse)
  }

  getBytes32(): Bytes {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x1f903037')
    const decodedResponse = evm.decode(new EvmDecodeParam('bytes32', response))
    return Bytes.fromHexString(decodedResponse)
  }

  getCallerAddress(): Address {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x46b3353b')
  ...
  getEnum(): u8 {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0xf0ebce5a')
  ...
  getFixedUintArray(): BigInt[] {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x09cf75a7')
  ...
  getInt(): BigInt {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x62738998')
  ...
  getMultipleValues(): GetMultipleValuesOutputs {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x650543a3')
  ...
  getString(): string {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x89ea642f')
    const decodedResponse = evm.decode(new EvmDecodeParam('string', response))
    return decodedResponse
  }

  getStringArray(): string[] {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x103b1828')
    const decodedResponse = evm.decode(new EvmDecodeParam('string[]', response))
    return decodedResponse === '' ? [] : parseCSVNotNullable(decodedResponse).map<string>((item0: string) => item0)
  }

  getUint(): BigInt {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x000267a4')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint256', response))
    return BigInt.fromString(decodedResponse)
  }

  getUintArray(): BigInt[] {
    const response = environment.contractCall(this._address, this._chainId, this._timestamp, '0x4fe1e215')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint256[]', response))
    return decodedResponse === ''
      ? []
      : parseCSVNotNullable(decodedResponse).map<BigInt>((item0: string) => BigInt.fromString(item0))
