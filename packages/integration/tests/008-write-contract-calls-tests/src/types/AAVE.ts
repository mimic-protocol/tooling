...
export class AAVE {
  ...
  ADDRESSES_PROVIDER(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x0542975c')
  ...
  BRIDGE_PROTOCOL_FEE(): BigInt {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x272d9072')
  ...
  FLASHLOAN_PREMIUM_TOTAL(): BigInt {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x074b2e43')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint128', response))
    return BigInt.fromString(decodedResponse)
  }

  FLASHLOAN_PREMIUM_TO_PROTOCOL(): BigInt {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x6a99c036')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint128', response))
    return BigInt.fromString(decodedResponse)
  }

  MAX_NUMBER_RESERVES(): u16 {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0xf8119d51')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint16', response))
    return u16.parse(decodedResponse)
  }

  POOL_REVISION(): BigInt {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x0148170e')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint256', response))
    return BigInt.fromString(decodedResponse)
  }
  ...
  getBorrowLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x2be29fa7')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }

  getBridgeLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0xdf374c36')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }
  ...
  getEModeLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0xf32b9a73')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }

  getFlashLoanLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x348fde0f')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }
  ...
  getLiquidationLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x911a3413')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }

  getPoolLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0xd3350155')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }
  ...
  getReservesCount(): BigInt {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x72218d04')
    const decodedResponse = evm.decode(new EvmDecodeParam('uint256', response))
    return BigInt.fromString(decodedResponse)
  }

  getReservesList(): Address[] {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0xd1946dbc')
    const decodedResponse = evm.decode(new EvmDecodeParam('address[]', response))
    return decodedResponse === ''
      ? []
  ...
  getSupplyLogic(): Address {
    const response = environment.contractCall(this.address, this.chainId, this.timestamp, '0x870e7744')
    const decodedResponse = evm.decode(new EvmDecodeParam('address', response))
    return Address.fromString(decodedResponse)
  }
