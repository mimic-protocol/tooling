...
export class ERC4626 {
  ...
  allowance(owner: Address, spender: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xdd62ed3e', [new CallParam('address', owner), new CallParam('address', spender)])
    )
    return BigInt.fromString(result)
  }

  asset(): Address {
    const result = environment.contractCall(this.address, this.chainId, this.timestamp, evmEncode('0x38d52e0f', []))
  ...
  balanceOf(account: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0x70a08231', [new CallParam('address', account)])
    )
    return BigInt.fromString(result)
  }
  ...
  convertToAssets(shares: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0x07a2d13a', [new CallParam('uint256', shares.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  convertToShares(assets: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xc6e6f592', [new CallParam('uint256', assets.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  maxDeposit(param0: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0x402d267d', [new CallParam('address', param0)])
    )
    return BigInt.fromString(result)
  }
  ...
  maxMint(param0: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xc63d75b6', [new CallParam('address', param0)])
    )
    return BigInt.fromString(result)
  }
  ...
  maxRedeem(owner: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xd905777e', [new CallParam('address', owner)])
    )
    return BigInt.fromString(result)
  }
  ...
  maxWithdraw(owner: Address): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xce96cb77', [new CallParam('address', owner)])
    )
    return BigInt.fromString(result)
  }
  ...
  previewDeposit(assets: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xef8b30f7', [new CallParam('uint256', assets.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  previewMint(shares: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0xb3d7f6b9', [new CallParam('uint256', shares.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  previewRedeem(shares: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0x4cdad506', [new CallParam('uint256', shares.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  previewWithdraw(assets: BigInt): BigInt {
    const result = environment.contractCall(
      ...
      this.chainId,
      this.timestamp,
      evmEncode('0x0a28a477', [new CallParam('uint256', assets.toBytesBigEndian())])
    )
    return BigInt.fromString(result)
  }
  ...
  totalAssets(): BigInt {
    const result = environment.contractCall(this.address, this.chainId, this.timestamp, evmEncode('0x01e1d114', []))
    return BigInt.fromString(result)
  }
